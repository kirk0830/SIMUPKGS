...
def overlap_matrix(basis_dict, distmat):

    """
    overlap matrix integral\n
    # input requirement\n
    basis_dict: basis information that has been saved in a dictionary\n
    distmat: distance matrix that has been saved in a 2-d array\n
    # output description\n
...
def kinetic_matrix(basis_dict, distmat):
        ...
        for icol in range(natom):
            for igau in range(len(basis_dict[irow])):
                for jgau in range(len(basis_dict[icol])):
                    ...
                    alpha_B = basis_dict[icol][jgau]
                    rAB2 = (distmat[irow][icol])**2
                    # make sure that Tij_Gau has been generalized!!!
# ----------------------still under construction------------------------
...
def Vne_matrix(basis_dict, distmat, chargelist, mode = 'all'):
...
def Vee_matrix(basis_dict, distmat):
